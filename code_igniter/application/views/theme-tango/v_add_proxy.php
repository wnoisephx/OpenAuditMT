...
echo form_open('admin_proxy/add_proxy')."\n";
?>
<fieldset id="proxy_details" class='niceforms'>
	...
	<tr>
		<td>
			<p><label for='proxy_name'><?php echo __("Name")?>: </label><input type='text' id='proxy_name' name='proxy_name' tabindex='1' title='Proxy Name'/></p>
