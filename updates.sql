...
/* config options */
INSERT INTO `openaudit`.`oa_config` (`config_name`, `config_value`, `config_editable`, `config_edited_date`, `config_edited_by`, `config_description`) VALUES ('multi_tenant', 'y', 'y', '0000-00-00 00:00:00.000000', '0', '');
